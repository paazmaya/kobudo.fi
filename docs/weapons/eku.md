...
title: Eku — Airo
slug: /aseet/eku
description: The eku, a boat oar used as a weapon by Okinawan fishermen, featuring distinctive sand-throwing techniques and close-quarters combat applications.
...
The **eku** (櫂, also called **kai**, **ウェーク**, or **エーク**) is the oar used for propelling _sabani_ boats. According to the 揆奮館 article, it is described as **"a fisherman's blade comparable to a sword,"** emphasizing that the oar was the **fisherman's principal weapon**, used both for paddling and for striking and cutting in close combat.
