...
Artikcelin 揆奮館流武術 mukaan **柱拐 (tunkuwa / tonfa)** on ase, joka perustuu **Fuzhou, Kiinasta**, jossa ase ja sen tekniikat olivat tunnetut ja termi _tonkua_ käytetään paikallisissa murteissa. Artikceli selittää, että tonfa kehittyi **mortin kahvasta (臼の柄ヘラ)** ja oli ensisijaisesti **puolustusase**: hallinnassa molemmilla käsillä vastaanottaa hyökkäyksiä miekoista, keihäistä tai bō:sta, riittävän iskuvoimalla että vastustajan ase voitaisiin lyödä kädestä.
