...
The **[Sakugawa no Kon](/kata/bo-kata)** family offers the clearest documented example of transmission divergence. The kata bears the name of **Sakugawa Kanga** (佐久川 寛賀, c. 1762–1843), a Shuri practitioner who reportedly studied in China. Today, versions of Sakugawa no Kon exist in:

- The **[Taira line](/tyylit/taira-linja)** (three variants: Shō, Chū, Dai)
- **[Matayoshi Kobudo](/tyylit/matayoshi)** (one version)
- **[Yamane-ryū](/tyylit/yamane-ryu)** (distinct choreography emphasizing the style’s fluid dynamic)
