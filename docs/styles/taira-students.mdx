...
# Taira Shinkinin oppilaat

<img
  src="/img/banner-taira-students.png"
  alt="Kuvaus kobudon harjoittajista esittelemassa eri aseitaan ryhmaassetuksessa"
  width={960}
  height={384}
  loading="lazy"
  className="kb-banner"
...
Taira Shinken asetti jalkeen pienen mutta vaikutusvaltaisen ryhmaan vanhempia oppilaita. Koska useimmat heista olivat jo kokeneet karate-kouluttajat eri tyyleissa ennen kobudon tutkimusta Tairan alaisella, hanen materiaali hajaantui useisiin erillisiin teknisiin perinteisiin. Tama sivu profiloi kahdeksan parhaiten dokumentoitua oppilasta, seurattuna muistio muista, joiden yhteys Tairaan on uskottava mutta vahemmän taysin dokumentoitu.
