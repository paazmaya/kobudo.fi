...
description: "Lisäksi Ryukyu-aseiden taideperinteet: Motobu Udundi, Tokushinryū ja karate-järjestelmät integroituneella aseen kurikkulum-systeemillä."
...
<img
  ...
  alt="Erilaisia kobudon harjoittajia esittelemassa erilaisia tyylejia"
  width={960}
  height={384}
  loading="lazy"
  className="kb-banner"
...
Kolmen paatyylin lisäksi, useita muita perinteitä sailyttavät Ryukyuan aseperinteet, joista osa on keskitettya yksittaiseen aseeseen, toiset integroidut karate-systeemeihin.
