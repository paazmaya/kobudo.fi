...
```
A fully built LEGO world bō kata action scene — every element made from LEGO bricks. A 48×12 stud grey 2×2 LEGO textured tile courtyard baseplate occupies the lower two-thirds with visible weathering patterns on the tiles. One LEGO minifigure in white gi torso print, dark grey legs, and a black hair element is posed in a maximum-reach striking stance using LEGO hinge-leg and hinge-arm elements: both arms extended forward-and-back gripping a 12L tan LEGO Technic axle bō staff at a bold horizontal diagonal sweep, the staff tip reaching past both frame edges to imply powerful centrifugal motion. The minifigure's printed face shows intense focused concentration — furrowed brow, piercing eyes fixed on an unseen target, jaw set with determination, suggesting complete immersion in the technique. The figure's wide-split low stance emphasises the force of the swing. Three dark red 2×4 LEGO brick wall courses line the back, each with a LEGO torch element — trans-orange 1×1 flame plate in a dark red 1×2 socket brick — throwing warm amber light forward and creating dramatic shadows. A sky of layered dark red and amber 2×2 LEGO flat tiles fills the upper frame, suggesting twilight atmosphere. The scene captures the dynamic energy of kata practice. A fully built LEGO world, vibrant saturated colors, visible studs and Technic axle-pin details throughout.
```
