...
**Prefix (start all prompts with):**

A fully built LEGO world [scene description] — every element made from LEGO bricks.

**Suffix (end all prompts with):**

A fully built LEGO world, vibrant saturated colors, visible studs throughout.

**Common LEGO elements:**

- dark red 2×4 LEGO bricks, dark red baseplates, dark red wall panels
- dark grey 2×4 LEGO bricks, dark grey baseplates
- trans-orange 1×1 flame plates in dark red socket bricks (torch elements)
- LEGO minifigures in printed gi/hakama torsos
- visible studs, anti-stud textures, brick seams

## Usage

Combine: **[Prefix]** + page-specific content + **[Suffix]**

## Home — Hero Banner

**URL:** `/en/`

A fully built LEGO world dojo interior — every element made from LEGO bricks. The floor is a grid of dark brown 2×4 LEGO tiles with visible stud texture. Three dark red 2×4 brick walls rise 6 courses high to a dark brown LEGO beam ceiling with exposed timber joists. Eight kobudo weapons are mounted symmetrically on the centre wall using 1×2 LEGO clip-tile hangers: a bō staff (twelve connected tan 4L Technic axles end-to-end, capped with 1×1 round tan plates at each tip), a sai pair (each: one 4L dark grey LEGO bar with two 2L bar-with-clip tines angled outward at 45° as yoku), a tonfa pair (each: one 6L brown LEGO round bar with a 1-stud perpendicular 2L bar handle attached via clip), a kama pair (each: one dark grey 1×2 curved slope blade brick on a 2L brown bar handle), and a tekko pair (each: one dark grey 1×4 arch brick). Four LEGO torch elements in dark red 1×2 socket bricks glow at the dojo corners with trans-orange 1×1 flame plates, casting warm amber pools of light and dramatic shadows across the floor. Two LEGO minifigures in white gi torso prints and black hip pieces stand flanking the wall. The left minifigure has a serene dignified expression with calm contemplative eyes and a subtle smile of quiet confidence. The right minifigure shows a focused respectful demeanor with attentive eyes and a composed expression of martial readiness. Both figures cast long stud-shadows from the corner torches. A fully built LEGO world, vibrant saturated colors, visible brick studs and anti-stud textures throughout, warm dojo atmosphere.
...
A fully built LEGO world scholar's desk — every element made from LEGO bricks. A dark grey 16×10 stud baseplate supports a desk: a 2×8 dark brown LEGO smooth tile surface resting on four 2×2 dark brown LEGO round column bricks as legs. On the desk surface sits a stack of five 2×3 dark bluish-grey LEGO tile pieces as books with a single 古武道 kanji pattern on the top book spine using black 1×1 plates, a rolled tan 1×4 LEGO round column as a scroll, a 1×2 dark tan LEGO tile as an inkstone, and a 1L black LEGO bar as a brush. A wall chart showing karate stance diagrams — shiko-dachi horse stance and zenkutsu-dachi lunge — in black 1×1 plate ink patterns leans against the dark grey 2×4 brick walls. A dark red 1×2 LEGO candle-holder brick with a single trans-orange 1×1 round flame plate stands at the desk corner as the only light source. Three sides of the scene are bounded by stacked dark grey 2×4 LEGO bricks reaching 4 courses high. A fully built LEGO world, vibrant saturated colors, visible studs throughout.
...
A fully built LEGO world stone dojo courtyard — every element made from LEGO bricks. A 48×16 stud grey 2×2 LEGO textured tile courtyard floor stretches across the scene with visible grout lines between each tile. The back wall is six courses of dark red 2×4 LEGO bricks with a subtle weathered texture, featuring a single LEGO torch element — trans-orange 1×1 flame plate in a dark red 1×2 socket brick — mounted on the left side, casting warm amber light that flickers across the scene. One LEGO minifigure stands in a respectful three-quarter pose at centre: grey-hair piece suggesting age and wisdom, white gi and dark grey hakama printed torso, dark grey LEGO legs. The minifigure's printed face shows a serene dignified expression — calm contemplative eyes, a gentle knowing smile suggesting decades of martial wisdom, weathered line details on the face print. The figure holds a single bō staff — a 12L tan LEGO Technic axle with 1×1 round tan plates capping each tip — upright at its right side, resting on the tile floor. The torch element casts a hard stud-shadow grid across the grey tile floor, creating dramatic diagonal shadows. Two dark grey 2×4 brick corner pillar stacks flank the back wall. The atmosphere is quiet and reverent, capturing the dignity of a master in his training space. A fully built LEGO world, vibrant saturated colors, visible studs throughout, soft atmospheric haze from the torchlight.
...
A fully built LEGO world dojo teaching scene at night — every element made from LEGO bricks. A 48×16 stud dark brown 2×4 LEGO tile floor with visible row seam lines and subtle wear patterns suggesting years of training. The back wall is five courses of dark red 2×4 LEGO bricks with a slightly rough texture. Four LEGO torch elements — each a trans-orange 1×1 flame plate in a dark red 1×2 socket brick — are mounted evenly spaced along the back wall, casting warm amber pools of light reflected in the dark brown tile floor studs, creating dramatic pools of illumination. Two LEGO minifigures stand centre-frame: a master figure in dark grey gi torso print stands behind a student figure in white gi print; both figures have their LEGO arms positioned holding a shared bō staff — a 12L tan LEGO Technic axle — the master's hands placed over the student's as if correcting grip. The master's printed face shows a patient mentoring expression — gentle focused eyes watching the student's hands, a subtle encouraging smile suggesting experienced guidance. The student's printed face displays eager attentiveness — wide eyes concentrating intently on the staff grip, a determined expression showing focused learning. Long hard stud-shadow lines radiate forward along the tile floor from each torch, creating dramatic light rays. The atmosphere is intimate and reverent, capturing a moment of knowledge transmission. A fully built LEGO world, vibrant saturated colors, visible studs throughout, warm torchlight glow.
...
A fully built LEGO world stone courtyard bojutsu scene — every element made from LEGO bricks. A 48×16 stud grey 2×2 LEGO textured tile courtyard baseplate fills the lower two-thirds with visible tile grout patterns. One LEGO minifigure in white gi torso print and dark grey legs is posed in a deep wide stance using LEGO hinge-leg elements, both arms fully extended gripping a 12L tan LEGO Technic axle bō staff at a bold horizontal diagonal sweep, the staff tip extending near both left and right frame edges implying maximum reach. The minifigure's printed face shows intense focused determination — furrowed brow, determined eyes fixed forward, set jaw suggesting exertion and concentration. The figure's wide-split low stance emphasises the force of the swing. A LEGO torch element — trans-orange 1×1 flame plate in a dark red socket brick — is mounted at ground level at the right edge, projecting a hard long rectangular stud-shadow grid forward from the minifigure's feet across the grey courtyard tiles toward the viewer. At the back, a low dark red 2×4 brick wall sits in front of a sky backdrop of stepped 2×2 LEGO flat tiles grading from dark red at top through dark orange to yellow at the horizon, suggesting a dramatic sunset atmosphere. Dust particles are implied in the torchlight beam. A fully built LEGO world, vibrant saturated colors, visible studs and Technic axle details throughout.
...
A fully built LEGO world close study of an eku boat oar — every element made from LEGO bricks. A dark red 48×12 stud LEGO baseplate covered in dark red 1×2 LEGO smooth flat tiles representing cloth. The eku oar lies diagonally across the frame: a 10L tan LEGO Technic axle as the cylindrical shaft, with a 2×4 tan LEGO flat tile plate attached at one end as the broad paddle blade, and a 1×1 round tan LEGO plate as the grip cap at the opposite end. The blade end shows a distinct oval shape with visible stud texture on the tile surface. The oar rests at a shallow diagonal angle showing the full length and the contrast between the smooth Technic axle shaft and the flat tile blade. A LEGO torch tile element positioned at the upper left casts warm amber light across the full length, highlighting the tan color variation and creating soft shadows on the dark red tile surface. A fully built LEGO world, vibrant saturated colors, visible studs throughout.
...
A fully built LEGO world close study of a kuwa hoe — every element made from LEGO bricks. A dark red 48×12 stud LEGO baseplate covered in dark red 1×2 LEGO smooth flat tiles representing dark earth or cloth. The kuwa lies with the blade at the lower left and handle extending toward the upper right: a 6L brown LEGO round bar as the long hardwood handle, ending with a 1×1 round brown LEGO plate as the grip cap; a dark grey 2×4 LEGO flat tile as the perpendicular blade set at a right angle to the handle via a 1×1 LEGO bar-with-clip connector; the blade tile shows a curved cutting edge formed by a 1×2 dark grey LEGO curved slope brick attached along one long edge. The L-shaped profile is clearly visible, showing the agricultural tool design. A LEGO torch tile element from the upper right creates metallic highlights on the dark grey blade slope and shows the wood grain texture of the brown round bar. A fully built LEGO world, vibrant saturated colors, visible studs throughout.
...
A fully built LEGO world close study of a nunti-bō trident spear — every element made from LEGO bricks. A dark red 48×12 stud LEGO baseplate covered in dark red 1×2 LEGO smooth flat tiles representing cloth. The nunti lies diagonally across the frame with the trident head at the upper right: an 8L tan LEGO Technic axle as the cylindrical hardwood shaft; the manji-sai head is built as a central 3L dark grey LEGO bar with a 1×1 pointed LEGO clip tip, flanked by two curved tines — one dark grey 2L bar-with-clip curved upward, one dark grey 2L bar-with-clip curved downward — attached via a 1×1 LEGO Technic connector pin at the shaft end, creating the asymmetric trident pattern. The dark grey iron elements contrast with the tan shaft. A LEGO torch tile element from the left casts sharp highlights on the pointed clip tip and curved tine ends, creating dramatic shadows across the dark red tile surface. A fully built LEGO world, vibrant saturated colors, visible studs throughout.
...
A fully built LEGO world showing a confused Okinawan martial artist searching through ancient scrolls in a dimly lit traditional dojo library — every element made from LEGO bricks. The practitioner, approximately 170cm tall in a white cotton keikogi gi and dark indigo hakama, stands surrounded by towering stacks of aged reference books built from dark bluish-grey 2×3 LEGO tile pieces and partially unrolled scrolls constructed from tan 1×4 LEGO round columns with a single 琉球 kanji calligraphy suggested by black 1×1 round plates. The figure's printed face shows a comically puzzled expression — raised eyebrows, wide confused eyes, a questioning frown, one hand raised to scratch the head in bewilderment. He holds one scroll up to dim light from a single iron lantern built from a dark red 1×2 socket brick with trans-orange flame plate. Dark crimson 2×4 LEGO brick walls create deep shadows around the scene, with 2×2 dark grey brick piles suggesting disorganized stacks. The atmosphere captures the feeling of searching for lost knowledge in traditional Ryukyu kobudo, with dramatic shadows and a sense of comic confusion. A fully built LEGO world, vibrant saturated colors, visible studs throughout.
...
A fully built LEGO world wide kata scroll diorama — every element made from LEGO bricks. A dark red 48×12 stud LEGO baseplate holds a horizontal scroll construction spanning the full width: twenty-four tan 1×2 LEGO smooth flat tiles in a single end-to-end row form the scroll surface. At each end, a dark tan 1×4 LEGO round column brick serves as the scroll roller. Along the tan tile surface, a single large 型 character pattern formed by six black 1×1 LEGO round plates sits at the centre as the main Japanese calligraphy kata character. Small ink sketches of karate stances — a shiko-dachi and zenkutsu-dachi — in black 1×1 plate patterns appear in the margins at each end of the scroll. A bright red 1×2 LEGO tile printed with a diamond pattern serves as a wax seal stamp at the right end. The left roller end is lit by a dark red 1×2 LEGO candle brick with a trans-orange 1×1 flame plate. The right end is shadowed by a stacked dark grey 2×2 LEGO brick overhang. A fully built LEGO world, vibrant saturated colors, visible studs throughout.
...
A fully built LEGO world bō kata action scene — every element made from LEGO bricks. A 48×12 stud grey 2×2 LEGO textured tile courtyard baseplate occupies the lower two-thirds with visible weathering patterns on the tiles. One LEGO minifigure in white gi torso print, dark grey legs, and a black hair element is posed in a maximum-reach striking stance using LEGO hinge-leg and hinge-arm elements: both arms extended forward-and-back gripping a 12L tan LEGO Technic axle bō staff at a bold horizontal diagonal sweep, the staff tip reaching past both frame edges to imply powerful centrifugal motion. The minifigure's printed face shows intense focused concentration — furrowed brow, piercing eyes fixed on an unseen target, jaw set with determination, suggesting complete immersion in the technique. The figure's wide-split low stance emphasises the force of the swing. Three dark red 2×4 LEGO brick wall courses line the back, each with a LEGO torch element — trans-orange 1×1 flame plate in a dark red 1×2 socket brick — throwing warm amber light forward and creating dramatic shadows. Faded ink wall drawings of karate stances and bō positions — a shiko-dachi low stance and a jodan-gamae guard — in black 1×1 plate patterns decorate the dark red brick walls. A sky of layered dark red and amber 2×2 LEGO flat tiles fills the upper frame, suggesting twilight atmosphere. The scene captures the dynamic energy of kata practice. A fully built LEGO world, vibrant saturated colors, visible studs and Technic axle-pin details throughout.
...
A fully built LEGO world sai kata action scene — every element made from LEGO bricks. A 48×12 stud grey 2×2 LEGO textured tile courtyard floor with visible grout lines and subtle wear marks from training. One LEGO minifigure in white gi torso print and dark grey legs stands in a wide horse stance, three-quarter view facing slightly left. Both arms are positioned at chest height in a crossed defensive guard: in each hand, a sai weapon — each built from a 4L dark grey LEGO smooth bar with two 2L dark grey bar-with-clip tines angled outward as yoku — is held with the tines facing forward in a crossed trapping block, one sai overlapping the other at the wrist. The minifigure's printed face shows intense focused vigilance — narrowed eyes watching for an opening, brow slightly furrowed in concentration, a firm set to the jaw showing defensive readiness. Dark red 2×4 LEGO brick walls rise four courses behind the figure with visible texture. Faded ink wall sketches of karate stances and sai guards — a kamae and zenkutsu-dachi lunge — in black 1×1 plate patterns decorate the dark red brick walls. A single LEGO torch element — trans-orange 1×1 flame plate in a dark red 1×2 socket brick — is wall-mounted at the right, casting a hard stud-grid shadow of the crossed sai and the minifigure forward across the grey tile floor, creating dramatic light pools. The atmosphere is tense and watchful, capturing a defensive moment in kata. A fully built LEGO world, vibrant saturated colors, visible studs throughout.
...
A fully built LEGO world scholar's library at night — every element made from LEGO bricks. A dark grey 48×12 stud LEGO baseplate serves as the floor. The back wall is five courses of dark grey 2×4 LEGO bricks divided into three bays by dark brown 1×2 LEGO pillar bricks. Each bay holds two rows of dark bluish-grey 2×3 LEGO tile pieces as books with smooth face-sides turned outward as spine-faces, the top book in each bay showing a single 研究 or 歴史 kanji pattern in black 1×1 plates. In the foreground a dark brown 2×8 LEGO smooth tile desk surface rests on four 2×2 dark brown LEGO round column bricks. On the desk: one 2×4 white LEGO open-book tile with a printed page face and a small 道 kanji character in black 1×1 plates, one 1L black LEGO bar as a brush, and a 1×2 dark tan LEGO tile as an inkstone. A wall chart showing karate stance diagrams in black 1×1 plate ink patterns leans against the left wall. A dark red 1×2 LEGO candle-holder brick with a single trans-orange 1×1 round flame plate stands at the desk corner as the sole light source, its warm amber glow picking out the book tile faces. Stacked dark grey 2×4 LEGO brick overhangs frame the outer edges in deep shadow. A fully built LEGO world, vibrant saturated colors, visible studs throughout.
